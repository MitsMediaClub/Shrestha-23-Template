  ...
  return (
    <div className="h-screen  ">
      <div className="flex gap-5 mx-20">
        <div className="w-1/2">
          <h1 className="p-3 border-b-2 w-1/2 text-3xl text-white drummer mb-5">
            EL CAMINO
          </h1>
        ...
        <img src={waves} alt="" className="w-1/2 h-[300px] mt-5" />
      </div>
      <h1 className="p-3 border-b-2 w-full text-3xl text-white drummer mb-5 ml-20">
        EL CAMINO
      </h1>
      <div className="flex gap-5 mx-20">
        <img src={gaming} alt="" className="w-1/2 h-[300px]" />
        <div className="w-1/2">
          <h1 className="text-blue quicksand">
            The universe is such a pretty big place. With a promise of never
            ending possibilities of infinity and beyond, SHRESTHA'23 are
