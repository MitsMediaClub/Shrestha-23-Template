    ...
    <div class="mx-20 sm:mx-2 mt-16">
      <div className="h-[80vh] md:h-[66vh] overflow-y-scroll">
        ...
        <div className="quicksand text-xl text-white p-4  mb-10 sm:w-full">
          <h1>
            1. Only students from{" "}
            <span className="font-extrabold text-2xl">
              Engineering colleges
            </span>{" "}
            are allowed to participate in the Techno-Cultural Events
          </h1>

          <br />
          <h1>
            2. Each participant is requested to have their college ID with them
            at all times.
          </h1>
          ...
          <br />
          <h1>
            6. Please do not carry sharp objects, inflammable objects or any
          ...
          <br />
          <h1>
            9. Any misbehaviour on part of the participants and visitors will
          ...
          <br />
          <h1>
            10. Anything that can be perceived as being offensive to any
            national and/or religious sentiments, gender, caste, race etc will
          ...
          <br />
          <h1>
            12. Rules listed are subject to change at the discretion of the
          ...
          <br />
          <h1>
            14. The decision of the Organizing Committee and judges shall be
