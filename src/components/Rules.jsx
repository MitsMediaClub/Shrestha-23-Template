    ...
    <div class="mx-20 sm:mx-2 mt-16">
      <div className="h-[80vh] md:h-[66vh] overflow-y-scroll">
        ...
        <div className="quicksand text-xl text-white p-4  mb-10 sm:w-full">
          <br />
          <h1>
            1. Each participant is requested to have their college ID with them
            at all times.
          </h1>

          <br />
          <h1>
            2. Participants must maintain decorum inside the campus. Any
            misbehavior will be dealt with severely.
          </h1>

          <br />
          <h1>3. Cross-college teams are not allowed for group events.</h1>

          <br />
          <h1>
            4. Any form of vulgarity or obscenity is strictly prohibited and any
          ...
          <br />
          <h1>
            5. Please do not carry sharp objects, inflammable objects or any
            other objects that might be potentially dangerous.
          </h1>

          <br />
          <h1>
            6. Please do not carry/consume any intoxicant, liquor, narcotics,
          ...
          <br />
          <h1>
            7. Any sort of profanity or obscenity in any form will lead to
            immediate disqualification.
          </h1>

          <br />
          <h1>
            8. Any misbehaviour on part of the participants and visitors will
            lead to expulsion from the premises and will reflect on their
            college.
          </h1>

          <br />
          <h1>
            9. Anything that can be perceived as being offensive to any national
          ...
          <br />
          <h1>
            10. If a participant is found violating any of these rules, it would
          ...
          <br />
          <h1>
            11. Rules listed are subject to change at the discretion of the
            Event Heads and the Organizing Committee.
          </h1>

          <br />
          <h1>
            12. Please bear in mind that all events, venues and timings are
            subject to change.
          </h1>

          <br />
          <h1>
            13. The decision of the Organizing Committee and judges shall be
      ...
      <Link to="/schedule">
        <button className=" mt-8 ml-4 text-white rounded-lg quicksand font-bold mx-auto  py-2 px-4 border-white-2 bg-opacity-70 border-white/30 border text-lg backdrop-blur bg-white/10 mb-10">
          Agree and Proceed
        </button>
      </Link>
    </div>
